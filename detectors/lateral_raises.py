...
class LateralRaiseDetector(BaseExercise):
    ...
    def process(self, landmarks):
        ...
        # Hip → Shoulder → Elbow
        #
        # Measures how far the arm has moved away from the body.
        # =====================================================
        ...
        # ELBOW ANGLES
        #
        # Used to check whether the arms remain reasonably
        # straight during the raise.
        # =====================================================
        ...
        # Arm down  → DOWN
        # Arm raised → UP
        # Returning down completes the rep.
        # =====================================================
        ...
        return {
            ...
            "shoulder_status": shoulder_position,
        }